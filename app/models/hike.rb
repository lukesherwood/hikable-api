class Hike < ApplicationRecord
  ...
  scope :filter_by_duration_category, -> (duration_category) {  where duration_category: duration_category } # this is probably missing the categories in an array [short, medium] etc
